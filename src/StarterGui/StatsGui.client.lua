...
local function render()
	...
	local deepestBlock = clampNumber(hasData and data.deepestBlock or data.currentDepth or 0)
	local totalBlocksDug = clampNumber(hasData and data.totalBlocksDug or data.blocksDug or 0)
