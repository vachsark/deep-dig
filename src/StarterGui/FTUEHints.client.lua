-- FTUEHints.client.lua — First-time user experience: spotlight tour of UI panels
...
-- Hints, in order. Position is the approximate panel button corner used to
-- place the spotlight cutout. The actual cutout box is loose (~±20px) — this
-- is a visual aid, not a tight crop.
--
-- Position semantics: UDim2 like the project's panels use.
--   anchorScaleX, anchorOffsetX, anchorScaleY, anchorOffsetY
local HINTS = {
	{
		title = "🐾 Pets",
...
-- ═══════════════════════════════════════════════════════════════════
-- Early-out: already shown this session
-- ═══════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════
-- Wait for character + initial dig delay
-- ═══════════════════════════════════════════════════════════════════
...
-- Dim overlay (full-screen). We draw a single dim Frame, then a "hole"
-- by stacking 4 darker Frames around the spotlight rect (top/bottom/left/right
-- bands). This gives a clean cutout effect without a stencil mask.
...
-- Resolves UDim2 against the player's current viewport size.
